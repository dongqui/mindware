...
const TodoModelSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'todoListId': IndexSchema(
      id: 136124475669128246,
      name: r'todoListId',
      unique: false,
      replace: false,
      properties: [
...
extension TodoModelQueryWhereSort
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhere> anyTodoListId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'todoListId'),
      );
    });
  }
}
...
extension TodoModelQueryWhere
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> createdAtGreaterThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> createdAtBetween(
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> todoListIdEqualTo(
      int todoListId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'todoListId',
        value: [todoListId],
      ));
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> todoListIdNotEqualTo(
      int todoListId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> todoListIdGreaterThan(
    int todoListId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> todoListIdLessThan(
    int todoListId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> todoListIdBetween(
    int lowerTodoListId,
    int upperTodoListId, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'todoListId',
        lower: [lowerTodoListId],
        includeLower: includeLower,
        upper: [upperTodoListId],
        includeUpper: includeUpper,
      ));
    });
  }
...
extension TodoModelQueryFilter
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> todoListIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> todoListIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> todoListIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoModelQuerySortBy on QueryBuilder<TodoModel, TodoModel, QSortBy> {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByTodoListId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'todoListId', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByTodoListIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQuerySortThenBy
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByTodoListId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'todoListId', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByTodoListIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'todoListId', Sort.desc);
    });
  }
...
extension TodoModelQueryWhereDistinct
  ...
  QueryBuilder<TodoModel, TodoModel, QDistinct> distinctByTodoListId() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQueryProperty
  ...
  QueryBuilder<TodoModel, int, QQueryOperations> todoListIdProperty() {
    return QueryBuilder.apply(this, (query) {
